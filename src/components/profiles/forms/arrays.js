export const film = [
		'Director', 'Director of Photography', "Producer", "Production Assistant", "Editor", "Camera Operator", "Drone Operator", "AC", "Grip", "Gaff"
	]
...
export const design = [
		"Illustration", "Set Design", "Motion Design", "2D/3D Design", "Graphic Design", "Animation", "Brand Design", "Web Design", "Art Direction"
	]

export const tech = [
	"Front End Developer", "Back End Developer", "Fullstack Developer", "UI/UX Design", "PHP Developer", "Wordpress/CMS Developer", "Software Developer", "Product Developer", "Product Design", "Web Design"
	]
